...
class CDSClient:
    ...
    def list_collections(self) -> "CDSCollectionResponse":
        ...
        collections = [
            CDSCollection(
                ...
                display_name="Articles & Preprints",
                subcollections=[
                    CDSCollection(
                        name="Published Articles", display_name="Published Articles"
                    ),
                    ...
                    CDSCollection(
                        name="CERN Internal Notes", display_name="CERN Internal Notes"
                    ),
                    CDSCollection(
                        name="Committee Documents", display_name="Committee Documents"
                    ),
                ],
            ),
            CDSCollection(
                name="Books & Proceedings",
                display_name="Books & Proceedings",
                subcollections=[
            ...
            CDSCollection(
                ...
                display_name="Presentations & Talks",
                subcollections=[
                    CDSCollection(
                        name="Conference Announcements",
                        display_name="Conference Announcements",
                    ),
                ],
            ),
            CDSCollection(
                name="Periodicals & Progress Reports",
                display_name="Periodicals & Progress Reports",
                subcollections=[
                    CDSCollection(name="Periodicals", display_name="Periodicals"),
                    CDSCollection(
                        name="Progress Reports", display_name="Progress Reports"
                    ),
                ],
            ),
            CDSCollection(
                name="Multimedia & Outreach",
                display_name="Multimedia & Outreach",
                subcollections=[
