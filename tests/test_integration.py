...
from cds_mcp.cds_client import CDSClient
...
def test_cds_api_connectivity():
    ...
    try:
        ...
        print("✅ CDS API is accessible. Found records.")
...
def test_search_functionality():
    ...
    try:
        ...
        if "error" in result:
            ...
            print(
                f"✅ Found {result['returned_count']} of {result['total_results']} documents"
            )
...
def test_helper_tools():
    ...
    try:
        ...
        exp_count = sum(
            len(exp_list) for exp_list in experiments["experiments"].values()
        )
...
def test_api_response_structure():
    ...
    try:
        ...
        response = requests.get(
            ...
            params={"p": "ATLAS", "of": "recjson", "rg": 1},
        )
